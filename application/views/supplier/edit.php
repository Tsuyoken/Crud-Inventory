    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="toko">Nama Toko</label>
                    <div class="col-md-9">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><i class="fa fa-fw fa-warehouse"></i></span>
                            </div>
                            <input value="<?= set_value('toko', $supplier['toko']); ?>" name="toko" id="toko" type="text" class="form-control" placeholder="Nama Toko...">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('npwp', $supplier['npwp']); ?>" name="npwp" id="npwp" type="text" class="form-control" placeholder="NPWP Supplier...">
                        </div>
