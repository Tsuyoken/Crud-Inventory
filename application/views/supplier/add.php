    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="toko">Toko</label>
                    <div class="col-md-9">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><i class="fa fa-fw fa-warehouse"></i></span>
                            </div>
                            <textarea name="toko" id="toko" class="form-control" rows="1" placeholder="Nama Toko..."><?= set_value('toko'); ?></textarea>
                        </div>
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="npwp">NPWP Supplier</label>
                    <div class="col-md-9">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><i class="fa fa-fw fa-pen"></i></span>
                            </div>
                            <input value="<?= set_value('npwp'); ?>" name="npwp" id="npwp" type="text" class="form-control" placeholder="NPWP Supplier...">
                        </div>
