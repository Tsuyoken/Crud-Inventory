    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="status">Kondisi</label>
                    <div class="col-md-5">
                        <div class="input-group">
                            <input value="<?= set_value('status'); ?>" name="status" id="status" type="text" class="form-control" placeholder="Kondisi Barang...">
                        </div>
