    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="stok">Stok Awal</label>
                    <div class="col-md-5">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="total_stok">Stok Akhir</label>
                    <div class="col-md-5">
                        <input readonly="readonly" id="total_stok" type="number" class="form-control">
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="ket">Keterangan Keluar</label>
                    <div class="col-md-5">
                        <div class="input-group">
