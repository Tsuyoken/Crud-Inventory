        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('id_barang', $id_barang); ?>" name="id_barang" id="id_barang" type="text" class="form-control" placeholder="ID Barang...">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="tgl_input">Tanggal Input</label>
                    <div class="col-md-9">
                        <input value="<?= set_value('tgl_input', date('Y-m-d')); ?>" name="tgl_input" id="tgl_input" type="text" class="form-control date" placeholder="Tanggal Masuk...">
                        <?= form_error('tgl_input', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="spek">Spek Barang</label>
                    <div class="col-md-9">
                        <input value="<?= set_value('spek'); ?>" name="spek" id="spek" type="text" class="form-control" placeholder="Spek Barang...">
                        <?= form_error('spek', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
                <div class="row form-group">
