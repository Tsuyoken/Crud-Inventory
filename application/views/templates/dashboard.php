...
<head>
    ...
    <title><?= $title; ?> | Aplikasi Inventaris Barang</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav bg-blue sidebar sidebar-dark accordion shadow-sm" id="accordionSidebar">
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Aplikasi Inventaris Barang 2021 &bull; by <?= anchor('https://fkenn.codes', 'Ferdi Kennedy'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
